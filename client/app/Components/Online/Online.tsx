  ...
  return (
    <div className="h-full relative pt-4 pb-4 flex-1 overflow-hidden">
      ...
      <div className="mt-2 mx-4">
        {onlineUsers?.map((user: IUser) => {
          return (
            <div
              key={user?._id}
              className={`mb-2 px-4 py-3 rounded-[50px] border-2 border-white flex gap-2 items-center bg-blue-50 dark:border-[#3C3C3C]/65 cursor-pointer hover:bg-blue-100 dark:bg-white/5 transition-colors duration-300 ease-in-out`}
            ...
            >
              ...
              <div className="flex flex-1 flex-col">
                <div className="flex justify-between items-center">
                  ...
                  >
                    En ligne <span className="text-green-500">•</span>
                  </p>
                </div>
      ...
      {onlineUsers?.length > 7 && (
        <div className="h-[300px] w-full absolute bottom-0 bg-gradient-to-t from-[#fff] to-transparent dark:from-[#000000]/50 dark:to-[#00000000] pointer-events-none" />
      )}
    </div>
  );
}
